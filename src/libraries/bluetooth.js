...
//         ],
//         optionalServices: [
//           prefix + serviceEnum.battery_service + suffix,
...
//       .getPrimaryService(prefix + service + suffix)
//       .then((service) => {
//         return service.getCharacteristic(prefix + characteristic + suffix);
//       })
//       .then((characteristic) => {
...
//     return XsensDotSensor.getCharacteristicData(
//       serviceEnum.message_service,
//       serviceEnum.message_acknowledge
//     ).then((value) => {
//       if (this.verbose) {
//         let str = `${getKeyByValue(
//           recMsgEnum,
//           dataViewObject.getUint8(2, true)
//         )} ack: ${getKeyByValue(recMsgAckEnum, value.getUint8(3, true))}`;
//         console.log(str);
//       }
//       return value;
//     });
...
//       })
//       .then((characteristic) => {
//         return characteristic.writeValue(dataViewObject);
//       })
//       .then(() => {
...
//    */
//   readDeviceName() {
//     return this.getCharacteristicData(
//       serviceEnum.configuration_service,
//       serviceEnum.device_control
//     )
//       .then((value) => {
//         let startOffset = 8;
//         let res = "";
...
//     )
//       .then((value) => {
//         dataViewObject = value;
//       }) // Get the current device control data and save it
//       .then(() => {
//         return this.device.gatt.getPrimaryService(
//           prefix + serviceEnum.configuration_service + suffix
//         );
//       })
//       .then((service) => {
//         return service.getCharacteristic(
//           prefix + serviceEnum.device_control + suffix
//         );
//       })
//       .then((characteristic) => {
...
//       })
//       .then(() => {
//         console.log("Identifying sensor");
//       })
//       .catch((error) => {
//         console.error(error);
//       });
...
//    */
//   subscribeToCharacteristicChangedNotifications(
//     listenerFunction,
//     service,
//     characteristic
//   ) {
...
//       .getPrimaryService(prefix + service + suffix)
//       .then((service) =>
//         service.getCharacteristic(prefix + characteristic + suffix)
//       )
...
//     let downloadArray = [["X", "      Y", "      Z", "      T"]].concat(
//       this.data
//     );
...
//     const value = event.target.value;
//     console.log(
//       `New notification message: ${getKeyByValue(
//         recMsgNotEnum,
//         value.getUint8(2, true)
//       )}`
//     );
//     console.log(value);
//   };
...
//    */
//   constructor() {
//     Object.keys(recMsgNotEnum).map((key) => {
//       notification_handler[key] = this.genericNotHandler;
//     });
//   }
...
//     notification_handler[getKeyByValue(recMsgNotEnum, notification_type)] =
//       callback_function;
//   }
...
//     const value = event.target.value;
//     let notification_type = getKeyByValue(
//       recMsgNotEnum,
//       value.getUint8(2, true)
//     );
...
//     })
//     .then(() => {
//       return XsensDotSensor.getInitialBatteryLevel().then((value) => {
//         XsensDotSensor.battery_level = value;
//         console.log("Battery Level: " + XsensDotSensor.battery_level);
//       });
//     })
//     .then(() => {
//       XsensDotSensor.subscribeToCharacteristicChangedNotifications(
//         XsensDotSensor.handleBatteryChanged,
//         serviceEnum.battery_service,
//         serviceEnum.battery_level
//       );
//     });
...
//     }
//     var result =
//       timestampArr[timestampArr.length - 24] |
...
//       if (
//         XsensDotSensor.timeArr[XsensDotSensor.timeArr.length - 1] >
//         XsensDotSensor.timeArr[XsensDotSensor.timeArr.length - 2]
//       ) {
//         XsensDotSensor.rawTime +=
//           XsensDotSensor.timeArr[XsensDotSensor.timeArr.length - 1] -
//           XsensDotSensor.timeArr[XsensDotSensor.timeArr.length - 2];
//       } else {
//         XsensDotSensor.rawTime +=
...
//     XsensDotSensor.rotation = new THREE.Euler().setFromQuaternion(
//       XsensDotSensor.quaternion,
//       "XYZ"
//     );
//     if (
//       Math.round(Math.abs(XsensDotSensor.rotation.x * 57.2957795)) == 90 ||
//       Math.round(Math.abs(XsensDotSensor.rotation.x * 57.2957795)) == 180
//     ) {
//       XsensDotSensor.rotation.x = prevRotation.x;
//     }
//     if (
//       Math.round(Math.abs(XsensDotSensor.rotation.y * 57.2957795)) == 90 ||
//       Math.round(Math.abs(XsensDotSensor.rotation.y * 57.2957795)) == 180
//     ) {
//       XsensDotSensor.rotation.y = prevRotation.y;
//     }
//     if (
//       Math.round(Math.abs(XsensDotSensor.rotation.z * 57.2957795)) == 0 ||
//       Math.round(Math.abs(XsensDotSensor.rotation.z * 57.2957795)) == 180
//     ) {
...
//   XsensDotSensor.subscribeToCharacteristicChangedNotifications(
//     handlePayload,
//     serviceEnum.measurement_service,
//     serviceEnum.short_payload_length
//   )
//     .then(() => {
//       // Set the normal message notification handler
//       return XsensDotSensor.subscribeToCharacteristicChangedNotifications(
//         NotificationHandler.handleNotification,
//         serviceEnum.message_service,
//         serviceEnum.message_notification
//       );
//     })
//     .then(() => {
...
//       XsensDotSensor.writeCharacteristicData(
//         serviceEnum.measurement_service,
//         serviceEnum.control,
//         dataViewObject
//       ).then(() => {
//         XsensDotSensor.verbose = true;
//         return;
//       });
//       return;
//     })
...
//       console.log(
//         `Angle: ${XsensDotSensor.max + Math.abs(XsensDotSensor.min)}`
//       );
...
// Exports;
// export { startRTStream, stopRTStream, findBluetoothDevices, XsensDotSensor };
